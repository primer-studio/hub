    ...
    <form class="uk-form-horizontal uk-margin-large" method="post">
        ...
        <div class="uk-margin">
            ...
            <div class="uk-form-controls">
                <input class="uk-input @error('name') uk-form-danger @enderror" id="name" name="name" type="text" placeholder="Publisher Name (Fa)" value="{{ $publisher->name }}">
            </div>
        </div>
        ...
        <div class="uk-margin">
            ...
            <div class="uk-form-controls">
                <input class="uk-input @error('website') uk-form-danger @enderror" id="website" name="website" type="text" placeholder="Publisher website url" value="{{ $publisher->website }}">
            </div>
        </div>
        ...
        <div class="uk-grid">
            <div class="uk-width-1-2@m">
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <textarea class="uk-textarea @error('feeds') uk-form-danger @enderror" id="feeds" name="feeds" rows=10>{{ $publisher->feeds }} </textarea>
            ...
            <div class="uk-width-1-2@m">
                <div class="uk-margin json-action-box">
                    ...
                    <input class="uk-input uk-margin-bottom" id="feed_url" name="feed_url" type="text" placeholder="feed url">
        ...
        <div class="uk-margin">
                ...
                <div class="uk-form-controls">
                    <input class="uk-input @error('avatar') uk-form-danger @enderror" id="avatar" name="avatar" type="text" placeholder="Publisher avatar url" value="{{ $publisher->avatar }}">
                </div>
        </div>
